...
class DrawableCorrespondences : public Drawable {
 public:
  ...
  DrawableCorrespondences(Eigen::Isometry3f transformation_, GLParameter *parameter_, int step_, const PointWithNormalAligner::CorrespondenceVector *correspondences_);
