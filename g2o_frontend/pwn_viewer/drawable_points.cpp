...
DrawablePoints::DrawablePoints(Eigen::Isometry3f transformation_, GLParameter *parameter_, int step_, PointWithNormalVector *points_) : Drawable(transformation_, step_) {
