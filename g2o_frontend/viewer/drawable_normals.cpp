...
DrawableNormals::DrawableNormals(Eigen::Isometry3f transformation_, GLParameter *parameter_, int step_, Vector6fVector *normals_) : Drawable(transformation_, step_) {
