...
namespace pwn {
  ...
  public:
    ...
    /**
     *  This method set the angular resolution to the one given in input.
     *  @param angularResolution_ is a float value used to update the angular resolution. 
     ...
     *  @see setVerticalFocalLenght()
     */
    inline float verticalFocalLenght() const { return _verticalFocalLenght; } 

    /**
     *  This method set the vertical focal length to the one given in input.
     *  @param verticalFocalLenght_ is a float value used to update the vertical focal length. 
  ...
  protected:
     ...
     *  @see projectIntervals()
     */
    inline int _projectInterval(const int x_, const int y_, const float d, const float worldRadius) const {
    ...
    float _verticalFocalLenght; /**< Veritcal focal lenght usually equal to the vertical center. */
    float _inverseVerticalFocalLenght; /**< Inverse of the veritcal focal lenght. */
    float _verticalCenter; /**< Veritcal center which usually is equal to the half of the rows of the depth image where the projector projects the points. */
