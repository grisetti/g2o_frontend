...
namespace pwn {
  ...
  public:
    ...
    /**
     *  Method that returns a constant reference to the vector of point traversability information.
     *  @return a constant reference to the vector of point traversability information.
     */
    inline const std::vector<int>& traversabilityVector() const { return _traversabilityVector; }

    /**
     *  Method that returns a reference to the vector of point traversability information.
     *  @return a reference to the vector of point traversability information.
     */
