...
void GradientMatcher::match(g2o::OptimizableGraph::Vertex* ref, g2o::OptimizableGraph::Vertex* curr){}
...
void GradientMatcher::scanMatch(const Vector2fVector& scan, const Vector3f& initialGuess)
{
    ...
    int bestScore = partialScore(scan, bestMove);
    int maxIterations = 5;
    float scale = 1.;

    Vector3f bestMoveAtResolution= bestMove;
    int bestScoreAtResolution = bestScore;
    ...
    for(int i = 0; i < maxIterations; ++i)
    {
        ...
        do {
            ...
            for(unsigned int m = 0; m < 6; ++m)
            {
                ...
                int innerScore = partialScore(scan, move);
